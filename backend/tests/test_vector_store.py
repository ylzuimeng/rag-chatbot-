...
def test_search_with_course_filter(mock_vector_store):
    ...
    # Execute
    results = mock_vector_store.search(query="test", course_name="Test Course")
...
def test_search_with_lesson_filter(mock_vector_store):
    ...
    # Execute
    results = mock_vector_store.search(query="test", lesson_number=1)
...
def test_search_with_course_and_lesson_filters(mock_vector_store):
    ...
    # Execute
    results = mock_vector_store.search(query="test", course_name="Test Course", lesson_number=2)
...
def test_vector_store_uses_max_results(mock_config):
    ...
    ), "CRITICAL: MAX_RESULTS is 0, this will cause empty search results"
